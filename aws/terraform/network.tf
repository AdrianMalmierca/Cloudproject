...
module "public_subnets" {
  ...
  subnets = {
    public_subnet_01 = {
      ...
      tags = {
        Environment = "proyecto_cloud"
        Name        = "proyecto_cloud_public_subnet_01"
        Type        = "public"
      }
    }
    public_subnet_02 = {
      ...
      tags = {
        Environment = "proyecto_cloud"
        Name        = "proyecto_cloud_public_subnet_02"
        Type        = "public"
      }
    }
    public_subnet_03 = {
      ...
      tags = {
        Environment = "proyecto_cloud"
        Name        = "proyecto_cloud_public_subnet_03"
        Type        = "public"
      }
    }
  }
...
module "private_subnets" {
  ...
  subnets = {
    private_subnet_01 = {
      ...
      tags = {
        Environment = "proyecto_cloud"
        Name        = "proyecto_cloud_private_subnet_01"
        Type        = "private"
      }
    }
    private_subnet_02 = {
      ...
      tags = {
        Environment = "proyecto_cloud"
        Name        = "proyecto_cloud_private_subnet_02"
        Type        = "private"
      }
    }
    private_subnet_03 = {
      ...
      tags = {
        Environment = "proyecto_cloud"
        Name        = "proyecto_cloud_private_subnet_03"
        Type        = "private"
      }
    }
  }
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Environment = "proyecto_cloud"
    Name        = "proyecto_cloud_public_route_table"
  }
}
...
module "allow_3000_from_alb" {
  ...
  description               = "Allow ALB to reach EC2 on port 3000"
}
